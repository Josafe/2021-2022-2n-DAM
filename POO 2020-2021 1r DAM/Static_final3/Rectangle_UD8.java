...
{
Rectangle rectangle1 = new Rectangle(1,3,1,4,0,100);
Rectangle rectangle2 = new Rectangle(5,8,6,9,0,100);
...
Rectangle rectangle3 = new Rectangle(5,7,6,9,0,100);
Rectangle rectangle4 = new Rectangle(5,8,6,9,0,100);
...
rectangle1.setX1Y1(2, 4);
rectangle1.setX2Y2(10, 20);
rectangle2.setAll(3, 6, 5, 9);
rectangle1.imprime();
rectangle2.imprime();
...
Rectangle rectangle5 = new Rectangle(1,2,3,6,0,100);
rectangle5.imprime();
