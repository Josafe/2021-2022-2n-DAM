...
public class main_Ex1 {
	...
	public static void main(String[] args) {
		...
		ex1 llibre3 = new ex1("2000","Resident Evil", "A", 600);
		...
		//Aixi definim que els llibres amb + 500 pag seran tochos o ladrillos amb la variable inicialitzada a 500
		
	for(int i = 0; i < array.length; i++) {
		if(array[i] instanceof Material && array[i].getNumPag() > f) { //Material representa llibre.
			System.out.println("Es un tocho");
		}
		array[i].mostrar();
	}
	...
	Usuari usuari1 = new Usuari("Jordi", "Querol", "23424324B", 28, null, null);
	Usuari usuari2 = new Usuari("Joan", "Sabater", "23424324V", 21, null, null);
	...
	/*for (int i = 0; i < 2; i++) {
		...
		Usuari array2 = new Usuari(nom, cognom, dni, edat, dni, dni);
		User.add(array2);
		User.add(array2);
	}*/
		int nllibre = 0;
