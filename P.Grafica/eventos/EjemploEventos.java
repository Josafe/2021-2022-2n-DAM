...
public class EjemploEventos extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EjemploEventos frame = new EjemploEventos();
    ...
    public EjemploEventos() {
         ...
         * si no lo indicamos aparecera una ventana muy pequenya
         */
        ...
        JButton btnAnadir= new JButton("Anyadir");
        ...
        btnAnadir.addActionListener(new ActionListener(){
            public void actionPerformed (ActionEvent e){
                ...
                textField.setText("");
                JOptionPane.showMessageDialog(contentPane, "Nombre Anyadido");
            }
        });
